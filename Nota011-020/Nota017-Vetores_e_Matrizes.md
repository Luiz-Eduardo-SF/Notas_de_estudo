...
Um **array** é uma estrutura de dados que permite armazenar múltiplos elementos do mesmo tipo em posições consecutivas na memória. Essa organização facilita o acesso rápido aos elementos.
...
**Uma coisa importante sobre arrays (e também sobre vetores em C) é que o primeiro elemento sempre começa no índice zero. Por exemplo, se você tiver um array de inteiros com 9 posições, os índices vão de 0 até 8.**
